...
class BioNN(nn.Module):
    def __init__(self, hidden_size: int = 768, labels_num: int = 18) -> None:
        # Deep Neural Network, FC (2 layers), the last layer is output layer
...
class BioDeepNN(nn.Module):
    # Deep Neural Network, FC (4 layers), the last layer is output layer
    def __init__(self, hidden_size: int = 768, labels_num: int = 18) -> None:
...
class BioResNet(nn.Module):
    # Deep Neural Network, ResNet network with 6 layers in total
    def __init__(self, hidden_size: int = 768, labels_num: int = 18) -> None:
